...
!(function (a) {
  a.extend(a.fn, {
    validate: function (b) {
      if (!this.length)
        return void (
          ...
          window.console &&
          console.warn(
            "Nada selecionado, não é possível validar, retornando nada."
          )
        );
    ...
    a.extend(a.validator, {
      ...
      messages: {
        ...
        maxlength: a.validator.format(
          "Por favor, indique no máximo {0} caracter(es)."
        ),
        minlength: a.validator.format(
          "Por favor, insira pelo menos {0} caracteres."
        ),
        rangelength: a.validator.format(
          "Por favor, insira um valor entre {0} e {1} caracteres."
        ),
    ...
    (a.format = function () {
      throw "$.format foi depreciado. Por favor, utilize $.validator.format em vez disso.";
    });
})(jQuery),
  (function (a) {
    var b,
